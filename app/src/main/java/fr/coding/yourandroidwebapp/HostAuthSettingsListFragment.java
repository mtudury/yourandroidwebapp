...
/**
 * A list fragment representing a list of HostAuths. This fragment
 * also supports tablet devices by allowing list items to be given an
 * 'activated' state upon selection. This helps indicate which item is
 * currently being viewed in a {@link HostAuthSettingsDetailFragment}.
 * <p/>
 * Activities containing this fragment MUST implement the {@link Callbacks}
 * interface.
 */
public class HostAuthSettingsListFragment extends ListFragment {
     ...
     */
    public HostAuthSettingsListFragment() {
    }
